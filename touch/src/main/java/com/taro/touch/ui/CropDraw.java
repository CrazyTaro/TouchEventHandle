...
//                        + "\ntop=" + mCropRecf.top + "\nbottom=" + mCropRecf.bottom);
    ...
    @Override
    public boolean isCanMovedOnX(@NonNull PointF moveDistancePointF, @NonNull PointF newOffsetPointF) {
        mTempDstRectf.set(mBitmapRecf);
        mTempDstRectf.offset(newOffsetPointF.x, 0);
        return (mTempDstRectf.left <= mCropRecf.left && mTempDstRectf.right >= mCropRecf.right);
    }

    @Override
    public boolean isCanMovedOnY(@NonNull PointF moveDistancePointF, @NonNull PointF newOffsetPointF) {
        mTempDstRectf.set(mBitmapRecf);
        mTempDstRectf.offset(0, newOffsetPointF.y);
