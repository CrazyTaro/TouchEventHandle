...
public class GrallyAndPhotoUtils {
     ...
     * @return
     */
    public static void openGrally(Activity act, @NonNull String pickerTitle) {
        if (act == null) {
            return;
        }
...
//        Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
        ...
        act.startActivityForResult(Intent.createChooser(intent, pickerTitle), REQUEST_CODE_OPEN_GRALLY);
        return;
    }
