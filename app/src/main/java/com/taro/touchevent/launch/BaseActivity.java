...
public abstract class BaseActivity extends Activity implements View.OnClickListener {
    public static final String ACTION_STANDARD = "2_intent_standard";
    public static final String ACTION_SINGLE_TOP = "2_intent_single_top";
    public static final String ACTION_SINGLE_TASK = "2_intent_single_task";
    public static final String ACTION_SINGLE_INSTANCE = "2_intent_single_instance";
